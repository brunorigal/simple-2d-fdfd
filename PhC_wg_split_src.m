...
type='triangular';
wgl=50; 
h_r=ones(7,wgl); % Array of holes sizes 
h_shx=zeros(7,wgl); % Array of holes x-shift along the array
h_shy=zeros(7,wgl); % Array of holes y-shift along the array

%Matrix h_r defines the geometry of the PhC circuit
h_r(4,1:25)=0;
h_r(1,28:end)=0;
h_r(7,25:end)=0;
h_r(6,25)=0;
